  ...
  return (
   <ProtectedRoute>
      ...
      <main className="mt-[60px]">
        {/* Banner */}
        <section className="bg-yellow-100 p-4  shadow-lg mb-6">
        <h2 className="text-lg md:text-xl font-bold text-yellow-700">
  \uD83C\uDF89 Congratulations, {user?.name || 'Guest'}! You are a lucky winner! \uD83C\uDF89
</h2>

          <p className="text-sm text-yellow-600">
            Claim your prize by reviewing the details below.
          </p>
        </section>
        ...
        <section className="bg-white p-4 rounded-lg shadow-lg mb-4 lg:w-full w-[91%] mx-auto ">
          ...
          <div className="flex flex-col justify-between items-start gap-8">
            ...
            <div className="flex items-center gap-3">
              <div className="p-4 hidden lg:block bg-blue-100 rounded-full">
                <svg
