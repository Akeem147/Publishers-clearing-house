...
const pastWinners = [
  { name: 'Emma Johnson', amount: 4120000, date: '2024-12-20', email: 'emma.johnson@example.com', state: 'New York', status: 'Claimed' },
  { name: 'Liam Anderson', amount: 5350000, date: '2024-12-25', email: 'liam.anderson@example.com', state: 'California', status: 'Pending' },
  { name: 'Olivia Smith', amount: 6000000, date: '2024-12-20', email: 'olivia.smith@example.com', state: 'Texas', status: 'Claimed' },
  { name: 'Jamie Castonguay', amount: 5000000, date: '2024-12-26', email: 'brainwilly.com', state: 'Arizona', status: 'Pending' },
  { name: 'Noah Williams', amount: 4500000, date: '2024-12-27', email: 'noah.williams@example.com', state: 'Florida', status: 'Claimed' },
  { name: 'Ava Brown', amount: 3700000, date: '2024-12-26', email: 'ava.brown@example.com', state: 'Washington', status: 'Pending' },
  { name: 'Ethan Davis', amount: 4000000, date: '2024-12-15', email: 'ethan.davis@example.com', state: 'Georgia', status: 'Canceled' },
  { name: 'Sophia Wilson', amount: 1200000, date: '2024-12-26', email: 'sophia.wilson@example.com', state: 'Illinois', status: 'Claimed' },
  { name: 'James Taylor', amount: 5500000, date: '2024-12-28', email: 'james.taylor@example.com', state: 'Arizona', status: 'Pending' },
];
